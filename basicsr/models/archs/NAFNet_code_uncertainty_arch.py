...
# v2 version, 把kernel attention conv2 的激活函数换为了sigmoid， 且kernel attention放在layer norm外面, 加上了kernel uncertainty
...
class NAFNet_code_uncertainty(nn.Module):
...
class NAFNet_code_uncertainty_Local(Local_Base, NAFNet_code_uncertainty):
    def __init__(self, *args, train_size=(1, 3, 256, 256), fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        NAFNet_code_uncertainty.__init__(self, *args, **kwargs)
...
if __name__ == '__main__':
    ...
    net = NAFNet_code_v2(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
